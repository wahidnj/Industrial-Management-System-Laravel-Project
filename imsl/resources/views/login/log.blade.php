      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Industrial Management</span></h4>
            ...
            <form method="POST" action="#" class="needs-validation" novalidate="">
              ...
              <!-- <div class="mt-5 text-center">
                Don't have an account? <a href="/home/auth-register">Create new one</a>
              </div> -->
            </form>

            <div class="text-center mt-5 text-small">
              Copyright &copy; Your Industrial Management. Made with 💙 by WRJ
              <div class="mt-2">
        ...
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="img/unsplash/login-bg.jpg">
          <div class="absolute-bottom-left index-2">
            <div class="text-light p-5 pb-2">
              <div class="mb-5 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Welcome To Login Page</h1>
