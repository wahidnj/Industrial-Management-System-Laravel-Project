      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Hi, {{$user['ename']}}</h2>
              ...
              <div class="col-12 col-md-12 col-lg-5">
                <div class="card profile-widget">
                  ...
                  <div class="profile-widget-description">
                    <div class="profile-widget-name">{{$user['ename']}} <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> Web Developer</div></div>
                    ...
                    <div class="card-body">
                        <div class="row">
                          <div class="form-group col-md-6 col-12">
                            <label>Name</label>
                            <input type="text" class="form-control" value="{{$user['ename']}}" required="">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-5 col-12">
                            <label>Phone</label>
                            <input type="tel" class="form-control" value="{{$user['contact']}}">
                          </div>
                        </div>
